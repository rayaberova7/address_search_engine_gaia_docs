...
- En Guyane, [**fonds de carte issus de données Pleiades**]{.orange} utilisés pour la collecte
...
- Communauté utilise ces données, ce qui donne lieu à la publication de [**contenu open-source**]{.orange} (détection de nuages, etc.)

## Une source de données à fort potentiel

- [**Pleiades**]{.orange} : données très haute résolution. Archives disponibles gratuitement pour l'Insee, et possibilité de faire des commandes (**tasking**), gratuites sous un certain quota 
...
- Appui pour l'[**organisation des enquêtes cartographiques**]{.orange} :
  ...
  - On récupère des données satellites couvrant ces îlots [**à la date de la précédente enquête**]{.blue2} cartographique et des [**données fraiches**]{.blue2}
